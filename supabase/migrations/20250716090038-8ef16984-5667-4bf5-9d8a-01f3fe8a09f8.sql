-- Insert some sample company holidays for testing (only if they don't exist)
DO $$
BEGIN
  -- Check if holidays already exist, if not insert them
  IF NOT EXISTS (SELECT 1 FROM public.company_holidays WHERE date = '2025-01-01') THEN
