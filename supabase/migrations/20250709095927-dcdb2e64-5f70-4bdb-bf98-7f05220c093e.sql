-- Clear all existing leave applications to start fresh
DELETE FROM public.leave_applied_users;

-- Fix the get_monthly_leave_balance function with proper EXTRACT syntax
...
-- Fix the get_total_remaining_leaves function as well
