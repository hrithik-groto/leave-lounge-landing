...
-- Add actual_days_used column to leave_applied_users if it doesn't exist
ALTER TABLE public.leave_applied_users 
ADD COLUMN IF NOT EXISTS actual_days_used NUMERIC DEFAULT 1;

-- Create table to track annual leave balances for each user
